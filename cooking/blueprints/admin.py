...
from cooking.forms import SettingForm, RecipeForm, CategoryForm, LinkForm
from cooking.models import Post, Category, Comment, Link
from cooking.utils import redirect_back, allowed_file
...
def manage_post():
    ...
    pagination = Post.query.order_by(Post.timestamp.desc()).paginate(
        page, per_page=current_app.config['COOKLOG_MANAGE_POST_PER_PAGE'])
...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('cook.show_post', post_id=post.id))
